...
def update_rolling_balls(resultTable, table, currentTime):
    return _phylib.update_rolling_balls(resultTable, table, currentTime)

def check_stopped_condition(resultTable):
    return _phylib.check_stopped_condition(resultTable)

def check_collision_condition(resultTable):
    return _phylib.check_collision_condition(resultTable)
